...
// end include: preamble.js
  ...
  function _dtd_adImpression(network, revenue, placement, unit) {
      try {
  ...
  function _dtd_cacheTestExperiment() {
      try {
  ...
  function _dtd_currentBalance(jsonString) {
      try {
  ...
  function _dtd_customEvent(name, params) {
      try {
  ...
  function _dtd_finishProgressionEvent(val, valJSON) {
      try {
  ...
  function _dtd_getTrackingAvailability() {
      try {
  ...
  function _dtd_initialize(appKey) {
      try {
  ...
  function _dtd_initializeWithConfig(
      appKey,
      userId,
      currentLevel,
  ...
  function dtd_sendMessage(methodName, message) {
  ...
  function _dtd_initializeWithRemoteConfig(appKey) {
      try {
  ...
  function _dtd_initializeWithRemoteConfigWithConfig(
      appKey,
      userId,
      currentLevel,
      trackingAvailability,
  ...
  function _dtd_invalidateActiveConfig() {
      try {
  ...
  function _dtd_isStorageAvailable() {
          try {
  ...
  function _dtd_levelUpWithResources(
      level,
      jsonBalance,
      jsonSpent,
      jsonEarned,
  ...
  function _dtd_migrateByDevice(appKey, migrationData) {
      try {
  ...
  function _dtd_migrateByUser(appKey, migrationData) {
      try {
  ...
  function _dtd_realCurrencyPayment(orderId, price, productId, currencyCode) {
      try {
  ...
  function _dtd_remoteConfigGetConfig() {
      try {
  ...
  function _dtd_replaceUserId(previousUserId, userId) {
      try {
  ...
  function _dtd_sendBufferedEvents() {
      window.devtodev.sendBufferedEvents();
    }

  function _dtd_setAppVersion(version) {
      try {
  ...
  function _dtd_setCurrentLevel(level) {
      try {
  ...
  function _dtd_setGroupWaiting(time) {
      try {
  ...
  function _dtd_setLoggerCallback() {
      window.devtodev.onDebugMessage(loggerCallback);
    }

  function _dtd_setSdkCodeVersion(version) {
      try {
  ...
  function _dtd_setSdkVersion(version) {
      try {
  ...
  function _dtd_setTrackingAvailability(value) {
      try {
  ...
  function _dtd_setUserId(userId) {
      try {
  ...
  function _dtd_socialNetworkConnect(name) {
      try {
  ...
  function _dtd_socialNetworkPost(name, reason) {
      try {
  ...
  function _dtd_startProgressionEvent(val, valJSON) {
      try {
        if (valJSON == null || UTF8ToString(valJSON).length == 0) {
  ...
  function _dtd_tutorial(step) {
      window.devtodev.tutorial(step);
    }

  function _dtd_userCheater(value) {
      window.devtodev.user.setCheater(!!value);
    }

  function _dtd_userDelete() {
      window.devtodev.user.clearUser();
    }

  function _dtd_userGet(key) {
  ...
  function _dtd_userSet(key, jsonValue) {
  ...
  function _dtd_userTester(value) {
      window.devtodev.user.setTester(!!value);
    }

  function _dtd_userUnset(jsonKeys) {
  ...
  function _dtd_virtualCurrencyPayment(
      purchaseId,
      purchaseType,
      purchaseAmount,
      args
  ...
  function _getRealUserId(req_id) {
...
var wasmImports = {
  ...
  "abort": _abort,
  "dlopen": _dlopen,
  "dtd_PopulateFromIDB": _dtd_PopulateFromIDB,
  "dtd_SyncToIDB": _dtd_SyncToIDB,
  "dtd_adImpression": _dtd_adImpression,
  "dtd_applyConfig": _dtd_applyConfig,
  "dtd_cacheTestExperiment": _dtd_cacheTestExperiment,
  "dtd_currencyAccrual": _dtd_currencyAccrual,
  "dtd_currentBalance": _dtd_currentBalance,
  "dtd_customEvent": _dtd_customEvent,
  "dtd_finishProgressionEvent": _dtd_finishProgressionEvent,
  "dtd_getAppVersion": _dtd_getAppVersion,
  "dtd_getCurrentLevel": _dtd_getCurrentLevel,
  "dtd_getGroupWaiting": _dtd_getGroupWaiting,
  "dtd_getItem": _dtd_getItem,
  "dtd_getLogLevel": _dtd_getLogLevel,
  "dtd_getSdkVersion": _dtd_getSdkVersion,
  "dtd_getTrackingAvailability": _dtd_getTrackingAvailability,
  "dtd_getUserId": _dtd_getUserId,
  "dtd_initialize": _dtd_initialize,
  "dtd_initializeWithConfig": _dtd_initializeWithConfig,
  "dtd_initializeWithRemoteConfig": _dtd_initializeWithRemoteConfig,
  "dtd_initializeWithRemoteConfigWithConfig": _dtd_initializeWithRemoteConfigWithConfig,
  "dtd_invalidateActiveConfig": _dtd_invalidateActiveConfig,
  "dtd_isStorageAvailable": _dtd_isStorageAvailable,
  "dtd_levelUp": _dtd_levelUp,
  "dtd_levelUpWithResources": _dtd_levelUpWithResources,
  "dtd_migrateByDevice": _dtd_migrateByDevice,
  "dtd_migrateByUser": _dtd_migrateByUser,
  "dtd_realCurrencyPayment": _dtd_realCurrencyPayment,
  "dtd_referrer": _dtd_referrer,
  "dtd_remoteConfigGetConfig": _dtd_remoteConfigGetConfig,
  "dtd_replaceUserId": _dtd_replaceUserId,
  "dtd_resetConfig": _dtd_resetConfig,
  "dtd_sendBufferedEvents": _dtd_sendBufferedEvents,
  "dtd_setAppVersion": _dtd_setAppVersion,
  "dtd_setCurrentLevel": _dtd_setCurrentLevel,
  "dtd_setGroupWaiting": _dtd_setGroupWaiting,
  "dtd_setIdentifierCallback": _dtd_setIdentifierCallback,
  "dtd_setInitializationCompleteCallback": _dtd_setInitializationCompleteCallback,
  "dtd_setLogLevel": _dtd_setLogLevel,
  "dtd_setLoggerCallback": _dtd_setLoggerCallback,
  "dtd_setSdkCodeVersion": _dtd_setSdkCodeVersion,
  "dtd_setSdkVersion": _dtd_setSdkVersion,
  "dtd_setTrackingAvailability": _dtd_setTrackingAvailability,
  "dtd_setUserId": _dtd_setUserId,
  "dtd_socialNetworkConnect": _dtd_socialNetworkConnect,
  "dtd_socialNetworkPost": _dtd_socialNetworkPost,
  "dtd_startProgressionEvent": _dtd_startProgressionEvent,
  "dtd_tutorial": _dtd_tutorial,
  "dtd_userCheater": _dtd_userCheater,
  "dtd_userDelete": _dtd_userDelete,
  "dtd_userGet": _dtd_userGet,
  "dtd_userSet": _dtd_userSet,
  "dtd_userTester": _dtd_userTester,
  "dtd_userUnset": _dtd_userUnset,
  "dtd_virtualCurrencyPayment": _dtd_virtualCurrencyPayment,
